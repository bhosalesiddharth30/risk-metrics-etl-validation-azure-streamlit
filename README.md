...
A[Sample Data Generator] -->|Creates 1350-row dataset| B[Azure Ingest Function]
B -->|Raw CSV| C[ETL Cleaner]
C -->|Normalized Data| D[Validation Engine]
D -->|Validation Report| E[Streamlit Dashboard]
D -->|Logs| F[Logger]
